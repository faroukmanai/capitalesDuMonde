//Le plus important dans ce projet c'est fetch API . tu appel un fichier json qui rempli de donnees. puis on utilise appendchild pour afficher les elements  qu'on a crée
...
function search(){
    ...
    countryDiv.innerHTML = `<span>country</span><br><p>${textCountry}</p>`;
